            ...
            <View style={styles.modalContainer}>
              <TouchableOpacity onPress={()=>{this.setState({visible:false})}} style={styles.modalBackground}>
                <View style={styles.loading}>
                  ...
                  {this.state.activeIndex? <View style={{flex:1,width:width,justifyContent:'center',alignItems:'center',backgroundColor:'#fff'}}>
                  ...
                  </View> : <View style={{flex:1,width:width,justifyContent:'center',alignItems:'center',backgroundColor:'#fff'}}>
